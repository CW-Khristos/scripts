...
dim colFOL(47), blnLOG, lngSIZ, strFOL
''SCRIPT OBJECTS
...
colFOL(8) = strPDFOL & "\MspPlatform\FileCacheServiceAgent\log"
colFOL(9) = strPDFOL & "\MspPlatform\PME\log"
colFOL(10) = strPDFOL & "\MspPlatform\PME.Agent.PmeService\log"
colFOL(11) = strPDFOL & "\MspPlatform\RequestHandlerAgent\log"
colFOL(12) = strPDFOL & "\MspPlatform\SolarWinds.MSP.CacheService\log"
colFOL(13) = strPDFOL & "\MspPlatform\SolarWinds.MSP.RpcServerService\log"
colFOL(14) = strPDFOL & "\N-Able Technologies\AVDefender\Logs"
colFOL(15) = strPDFOL & "\N-able Technologies\AutomationManager\Logs"
colFOL(16) = strPDFOL & "\N-able Technologies\AutomationManager\temp"
colFOL(17) = strPDFOL & "\N-able Technologies\AutomationManager\ScriptResults"
colFOL(18) = strPDFOL & "\SolarWinds MSP\AutomationManager\Logs"
colFOL(19) = strPDFOL & "\SolarWinds MSP\PME\log"
colFOL(20) = strPDFOL & "\SolarWinds MSP\SolarWinds.MSP.Diagnostics\Logs"
colFOL(21) = strPDFOL & "\SolarWinds MSP\SolarWinds.MSP.CacheService\log"
colFOL(22) = strPDFOL & "\SolarWinds MSP\SolarWinds.MSP.PME.Agent.PmeService\log"
colFOL(23) = strPDFOL & "\SolarWinds MSP\SolarWinds.MSP.RpcServerService\log"
''PROGRAM FILES (X86)
colfol(24) = str86FOL & "\N-able Technologies\Reactive\Log"
colfol(25) = str86FOL & "\N-able Technologies\Tools\Log"
colfol(26) = str86FOL & "\N-able Technologies\Windows Agent\Log"
colfol(27) = str86FOL & "\N-able Technologies\Windows Software Probe\Log"
colfol(28) = str86FOL & "\N-able Technologies\Windows Software Probe\syslog\Log"
''THESE FOLDERS ARE NORMAL FOLDER PATHS
colFOL(29) =  "C:\temp"
colFOL(30) = "C:\inetpub\logs\LogFiles\W3SVC2"
colfol(31) = "C:\inetpub\logs\LogFiles\W3SVC1"
''EXCHANGE LOGGING FOLDERS
if (objFSO.folderexists(strPFFOL & "\Microsoft\Exchange Server")) then
  colFOL(32) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\Diagnostics\AnalyzerLogs"
  colFOL(33) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\Diagnostics\CertificateLogs"
  colFOL(34) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\Diagnostics\CosmosLog"
  colFOL(35) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\Diagnostics\DailyPerformanceLogs"
  colFOL(36) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\Diagnostics\Dumps"
  colFOL(37) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\Diagnostics\EtwTraces"
  colFOL(38) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\Diagnostics\Poison"
  colFOL(39) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\Diagnostics\ServiceLogs"
  colFOL(40) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\Diagnostics\Watermarks"
  colFOL(41) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\MailboxAssistantsLog"
  colFOL(42) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\MailboxAssociationLog"
  colFOL(43) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\MigrationMonitorLogs"
  colFOL(44) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\RpcHttp\W3SVC1"
  colFOL(45) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\RpcHttp\W3SVC2"
  colFOL(46) = strPFFOL & "\Microsoft\Exchange Server\V15\Logging\HttpProxy\RpcHttp"
end if

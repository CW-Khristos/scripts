...
sub CHKAU()																					                  ''CHECK FOR SCRIPT UPDATE, MSP_DEBUG.VBS, REF #2 , FIXES #24
  ...
  if (objFSO.fileexists("C:\Program Files (x86)\N-Able Technologies\Windows Agent\cache\" & wscript.scriptname)) then
	...
	if objXML.load("https://github.com/CW-Khristos/scripts/raw/master/version.xml") then
        ...
        objOUT.write vbnewline & now & vbtab & " - MSP_Debug :  " & strVER & " : GitHub : " & objSCR.text & vbnewline
        objLOG.write vbnewline & now & vbtab & " - MSP_Debug :  " & strVER & " : GitHub : " & objSCR.text & vbnewline

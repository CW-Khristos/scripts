...
''SCRIPT IS DESIGNED TO ATTEMPT FORCE SELF-HEAL OF MSP BACKUP SYSTEM STATE USING 'PS' CMD AND CLIENTTOOL.EXE UTILITY
...
sub CLEANUP()                                 			        ''SCRIPT CLEANUP
  ...
  elseif (errRET <> 0) then    											        ''MSP_SSHEAL_FORCE_PS FAILED
    objOUT.write vbnewline & vbnewline & now & vbtab & " - MSP_SSHEAL_FORCE_PS FAILURE : " & errRET & " : " & now
    objOUT.write vbnewline & vbnewline & now & vbtab & " - MSP_SSHEAL_FORCE_PS FAILURE : " & errRET & " : " & now

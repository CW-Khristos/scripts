  ...
  if objXML.load("https://github.com/CW-Khristos/scripts/raw/master/version.xml") then
    ...
    for each objSCR in colVER.ChildNodes
      ...
      if (lcase(objSCR.nodename) = lcase(wscript.scriptname)) then
        ...
        objOUT.write vbnewline & now & vbtab & " - MSP_Update :  " & strVER & " : GitHub : " & objSCR.text & vbnewline
        objLOG.write vbnewline & now & vbtab & " - MSP_Update :  " & strVER & " : GitHub : " & objSCR.text & vbnewline

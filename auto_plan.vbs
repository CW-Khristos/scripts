...
sub CHKAU()																									''CHECK FOR SCRIPT UPDATE, AUTO_PLAN.VBS, REF #2 , REF #6 , FIXES #5
  ...
  if (objFSO.fileexists("C:\Program Files (x86)\N-Able Technologies\Windows Agent\cache\" & wscript.scriptname)) then
	...
	if objXML.load("https://github.com/CW-Khristos/scripts/raw/Auto_Plan/version.xml") then
        ...
        objOUT.write vbnewline & now & vbtab & " - Auto_Plan :  " & strVER & " : GitHub : " & objSCR.text & vbnewline
        objLOG.write vbnewline & now & vbtab & " - Auto_Plan :  " & strVER & " : GitHub : " & objSCR.text & vbnewline

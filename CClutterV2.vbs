...
''------------
''BEGIN SCRIPT
objOUT.write vbnewline & vbnewline & now & vbtab & " - EXECUTING CCLUTTERv2"
objLOG.write vbnewline & vbnewline & now & vbtab & " - EXECUTING CCLUTTERv2"
...
if (blnLOG) then
  if (objFSO.fileexists("C:\temp\cclutter.txt")) then       ''LOGFILE EXISTS
    ...
    set objLOG = objFSO.createtextfile("C:\temp\cclutterv2.txt")
    objLOG.close
    set objLOG = objFSO.opentextfile("C:\temp\cclutterv2.txt", 8)
...
sub CLEANUP()                                     ''SCRIPT CLEANUP
  strNEW = vbnewline & "CCLUTTERv2 COMPLETE : CLEARED " & round((lngSIZ / 1024),2) & " MB"
  objOUT.write strNEW
